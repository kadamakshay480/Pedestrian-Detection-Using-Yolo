...
cap = cv2.VideoCapture("C:/Users/user/Downloads/mixkit-quiet-tokyo-street-at-night-4451-medium.mp4")
writer = None
...
while True:
    ...
    key = cv2.waitKey(1)
    if key == 27 or cv2.getWindowProperty("Detection", cv2.WND_PROP_VISIBLE) < 1:
        break
